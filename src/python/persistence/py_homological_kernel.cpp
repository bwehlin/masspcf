...
namespace
{
  ...
  template <typename T> class PyHomologicalKernelBindings
  {
  public:
    ...
    {
      // TODO: return sb_py::execute_stoppable_task<...>(pclouds, pcloudsPrime, out);
      return nullptr;
    }
    ...
    static std::unique_ptr<sb::StoppableTask<void>> spawn_homological_kernel_distmat_task(
        ...
        sb::Tensor<sb::ph::Barcode<T>> &out)
    {
      // TODO: return sb_py::execute_stoppable_task<...>(dmats, dmatsPrime, out);
      return nullptr;
    }
    ...
    static void register_bindings(py::module_ &m, const std::string &suffix)
    {
      py::class_<PyHomologicalKernelBindings>(m, ("HomologicalKernel" + suffix).c_str())
          .def_static("spawn_homological_kernel_pcloud_task",
                      &PyHomologicalKernelBindings::spawn_homological_kernel_pcloud_task)
          .def_static("spawn_homological_kernel_distmat_task",
